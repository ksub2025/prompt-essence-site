...
const steps = [
  { icon: Users, title: "1. Form Your Team", description: "Register a team of 1–6 members. Each team selects one subsection (Idea Lab, Portfolio Pathways, Intrapreneurship, or Case of Crisis)." },
