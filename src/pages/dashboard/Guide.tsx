...
const steps = [
  { icon: Users, title: "1. Form Your Team", description: "Register a team of 2–6 members. Each team selects one subsection (Idea Lab, Portfolio Pathways, Intrapreneurship, or Case of Crisis)." },
  ...
  { icon: RefreshCw, title: "4. Bring-Back Round", description: "Eliminated? Don't worry. One bring-back round lets you re-enter after improving your submission — just like real startups iterate." },
