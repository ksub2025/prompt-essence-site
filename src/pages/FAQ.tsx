...
const faqs = [
  ...
  { q: "Who can participate?", a: <>The competition is open to youth worldwide who are interested in business, finance and economics. Teams of 2–6 members register through the <Link to="/waitlist" className="text-primary hover:underline">waitlist</Link> and select a subsection such as Initiation, Path Drawer, Operator or Planned Chaos.</> },
