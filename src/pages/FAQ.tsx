...
const faqs = [
  ...
  { q: "Who can participate?", a: <>The competition is open to youth worldwide who are interested in business, finance and economics. Teams of 1–6 members <Link to="/register" className="text-primary hover:underline">register</Link> and select a subsection such as Idea Lab, Portfolio Pathways, Intrapreneurship or Case of Crisis.</> },
  { q: "How is the competition structured?", a: <>VentureCapsule features 3 main rounds and 1 bring-back round. Eliminated teams can re-enter during the bring-back round. See the full <Link to="/structure" className="text-primary hover:underline">competition structure</Link> for details.</> },
  ...
  { q: "What makes VentureCapsule different?", a: <>VentureCapsule goes beyond pitching with diverse <Link to="/subsections" className="text-primary hover:underline">competition pathways</Link>, professional mentoring, idea incubation opportunities after the competition, and a unique bring-back round. See all <Link to="/benefits" className="text-primary hover:underline">participant benefits</Link>.</> },
];
