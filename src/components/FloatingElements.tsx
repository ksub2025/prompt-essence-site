...
// Positioned around the edges, away from the left-aligned hero text & buttons
const items: FloatingItem[] = [
  { src: stockchart, alt: "Stock Chart", size: 68, x: "82%", y: "10%", delay: 0.8, duration: 6 },
  { src: idea, alt: "Idea", size: 60, x: "88%", y: "40%", delay: 1, duration: 5.8 },
  { src: trophy, alt: "Trophy", size: 54, x: "78%", y: "70%", delay: 1.8, duration: 6.2 },
  { src: handshake, alt: "Handshake", size: 58, x: "70%", y: "22%", delay: 0.3, duration: 5.4 },
  { src: briefcase, alt: "Briefcase", size: 56, x: "92%", y: "65%", delay: 0.7, duration: 5.2 },
  { src: barchart, alt: "Bar Chart", size: 62, x: "75%", y: "48%", delay: 0.5, duration: 5.3 },
  { src: rocket, alt: "Rocket", size: 56, x: "65%", y: "80%", delay: 0.4, duration: 5.1 },
  { src: chart, alt: "Chart", size: 52, x: "85%", y: "85%", delay: 2.0, duration: 6.3 },
];
